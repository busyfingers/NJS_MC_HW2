            ...
            _data.read("carts", id).then(_cartData => {
                ...
                Object.keys(items).forEach(key => {
                    ...
                    if (newQuantity === 0 && cartData.items[key] !== undefined) {
                        ...
                        let amount = parseInt(menu[key].replace("$", "")) * newQuantity;
                ...
                cartData.items["totalAmount"] = `$${totalAmount}`;
...
// Returns a status code and an object representing the handler return data
handlers.orders = handlers.mainHandler("_orders", ["post", "get", "delete"]);
